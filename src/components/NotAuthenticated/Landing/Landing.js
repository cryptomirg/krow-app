        ...
        return (
            <div>
                <div
                    ...
                    data-background-image="images/chores.jpg"
                >
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 col-md-8 col-sm-12">
                                    <h2>
                                        Hire Locals To Do Chores <br /> Any Job,
                                        Any Time.
                                    </h2>
                                    <p>
                                        Join hundreds of others by hiring or
                                        earning money right in your
                                        neighborhood. We let you pick any
                                        service from cleaning, to lawn-mowing,
                                        to even pet-sitting on any day and time.
                                        Getting any to-do list done becomes
                                        possible with Krow! Sign up for free
                                        below.
                                    </p>
                                    <Link
                                        to="/login"
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-md-4">
                                <div className="icon-box with-line">
                                    ...
                                    <h3>Request a Job</h3>
                                    <p>
                                        Hire somebody for one of our many job
                                        types with a date/time tailored to you
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-md-4">
                                <div className="icon-box with-line">
                                    ...
                                    <p>
                                        A trusted Krow freelancer will show up
                                        to perform the task at the given time.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-md-4">
                                <div className="icon-box">
                                    ...
                                    <p>
                                        You pay and review your freelancer for
